...
function FarmerProfile({ userId, profileStatus, handleProfileToggle }) {
    ...
    return (
        ...
        //     <div className={`bg-[#3f7d58] rounded-lg p-6 sm:p-8 md:p-10 w-full max-w-4xl flex flex-col md:flex-row justify-around items-center space-y-4 md:space-y-0 md:space-x-10 mx-8 my-4 shadow-lg relative ${profileStatus ? "scale-1" : "-scale-0"}  transition-all duration-500`}>
        ...
        //         {/* Avatar and Info */}
        //         <div className="px-4 py-6 w-full flex flex-col md:items-center md:text-left border border-[#fff] rounded-lg  ">
        //             <img
        ...
        //                 <textarea className="w-full px-3 py-1 border border-slate-400 outline-none rounded-md text-sm text-[#fff] transition-all duration-300 my-2 focus:border-[#3F7D58] bg-white  bg-opacity-20 " id="address" value={formData.address || ""} onChange={handleChange} />
        //             </div>

        //             <button className="w-full px-4 py-2 text-[#fff] border-2 border-[#fff] font-medium hover:bg-[#fff] hover:text-[#3f7d58] rounded-md transition-all duration-300 my-4" type="submit">
        //                 Save
        //             </button>
        //         </form>
        //     </div>
  ...
  <div className={`bg-[#3f7d58] rounded-lg p-6 sm:p-8 md:p-10 w-full max-w-4xl flex flex-col md:flex-row justify-around items-center space-y-4 md:space-y-0 md:space-x-10 mx-8 my-4 shadow-lg relative ${profileStatus ? "scale-1" : "-scale-0"} transition-all duration-500 overflow-y-auto max-h-[90vh]`}>
    ...
    {/* Avatar and Info */}
    <div className="px-4 py-6 w-full flex flex-col items-center  border border-[#fff] rounded-lg">
      <img
        src={formData.profilePhoto || avatarIcon}
        alt="avatar"
        className="w-[150px] h-[150px] object-cover border border-white p-1 mb-4 rounded-full"
